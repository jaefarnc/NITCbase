...
OpenRelTable::OpenRelTable(){
  ...
  *(RelCacheTable::relCache[RELCAT_RELID]) = relCacheEntry;
  ...
  //setup the relation cache entry for the attribute catalog similarly 
  ...
  *(RelCacheTable::relCache[ATTRCAT_RELID]) = relCacheEntry;
  ...
  //    and attrCacheEntry.next similarly 
  ...
  //read slots 6-11 from attrCatBlock and initialize recId appropriately 
